# Contributing to pkg-audioreach-graphservices
...
1. [Fork](https://github.com/qualcomm-linux/pkg-audioreach-graphservices/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-audioreach-graphservices.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-audioreach-graphservices.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-audioreach-graphservices/pulls) from your branch to `main`.
